...
export const DEFAULT_ACHIEVEMENTS: Achievement[] = [
  ...
  { id: ACHIEVEMENT_ID.WHISPERS_OF_LOVE, name: 'Whispers of Love (20) 💖', description: "Uncovered 20 unique sentiments hidden within the heart. What secrets lie within?", criteria: { target: 20 }, isUnlocked: false, progress: 0, category: ACHIEVEMENT_CATEGORY.UNIQUE_HEART_MESSAGES },
  { id: ACHIEVEMENT_ID.HEARTFELT_DISCOVERER, name: 'Heartfelt Discoverer (40) 💫', description: "Revealed 40 distinct insights from the depths of the heart. Keep digging!", criteria: { target: 40 }, isUnlocked: false, progress: 0, category: ACHIEVEMENT_CATEGORY.UNIQUE_HEART_MESSAGES },
  { id: ACHIEVEMENT_ID.EMPATHETIC_EXPLORER, name: 'Empathetic Explorer (60) ✨', description: "Journeyed through 60 unique expressions found in the heart. Are you sure you're not a mind reader?", criteria: { target: 60 }, isUnlocked: false, progress: 0, category: ACHIEVEMENT_CATEGORY.UNIQUE_HEART_MESSAGES },
  { id: ACHIEVEMENT_ID.SOULFUL_SCHOLAR, name: 'Soulful Scholar (80) 💡', description: "Deciphered 80 hidden wisdoms radiating from the heart. You're practically fluent!", criteria: { target: 80 }, isUnlocked: false, progress: 0, category: ACHIEVEMENT_CATEGORY.UNIQUE_HEART_MESSAGES },
  { id: ACHIEVEMENT_ID.HEART_MESSAGE_MANIAC, name: 'Heart Message Maniac (100) 🤯', description: "Master of mysteries! You've read ALL 100 unique messages from the heart! Go touch some grass.", criteria: { target: 100 }, isUnlocked: false, progress: 0, category: ACHIEVEMENT_CATEGORY.UNIQUE_HEART_MESSAGES },

  // GRAPH GENERATION & CREATION //
  // PROGRESSION for random graph generation
  { id: ACHIEVEMENT_ID.RANDOM_CRAFTER_20, name: 'Random Crafter (20) 🎲', description: "Summoned 20 unique random graphs into existence. Feeling lucky?", criteria: { target: 20 }, isUnlocked: false, progress: 0, category: ACHIEVEMENT_CATEGORY.RANDOM_GENERATOR },
  { id: ACHIEVEMENT_ID.CHAOS_ARCHITECT_40, name: 'Chaos Architect (40) 🌀', description: "Mastered the art of randomness by generating 40 graphs. Controlled chaos, delightful!", criteria: { target: 40 }, isUnlocked: false, progress: 0, category: ACHIEVEMENT_CATEGORY.RANDOM_GENERATOR },
  { id: ACHIEVEMENT_ID.GENERATOR_GURU_60, name: 'Generator Guru (60) ✨', description: "Achieved enlightenment by creating 60 diverse random graph structures. Who needs a plan?", criteria: { target: 60 }, isUnlocked: false, progress: 0, category: ACHIEVEMENT_CATEGORY.RANDOM_GENERATOR },
  { id: ACHIEVEMENT_ID.INFINITY_WEAVER_80, name: 'Infinity Weaver (80) 🌌', description: "Tapped into the endless possibilities, generating 80 random graphs. The universe is yours!", criteria: { target: 80 }, isUnlocked: false, progress: 0, category: ACHIEVEMENT_CATEGORY.RANDOM_GENERATOR },
  { id: ACHIEVEMENT_ID.GRAPH_GOD_100, name: 'Graph God (100) 👑', description: "The ultimate creator! You've generated 100 random graphs, shaping digital destiny! Bow down.", criteria: { target: 100 }, isUnlocked: false, progress: 0, category: ACHIEVEMENT_CATEGORY.RANDOM_GENERATOR },

  // PROGRESSION for local save
  { id: ACHIEVEMENT_ID.LOCAL_HERO, name: 'Local Hero 💾', description: "You're a data hoarder! Saved 10 graphs to local storage, just in case.", criteria: { target: 10 }, isUnlocked: false, progress: 0, category: ACHIEVEMENT_CATEGORY.LOCAL_SAVE},

  // PROGRESSION for creating
  { id: ACHIEVEMENT_ID.NODE_WHISPERER, name: 'Node Whisperer 🌱', description: "You talk to nodes, and they listen! Created 10,000 nodes, a true population boom.", criteria: { target: 10000 }, isUnlocked: false, progress: 0, category: ACHIEVEMENT_CATEGORY.NODE_CREATOR },
  { id: ACHIEVEMENT_ID.EDGE_LORD, name: 'Edge Lord 🧷', description: "Lord of the connections! You've forged 10,000 edges. Are you building a web?", criteria: { target: 10000 }, isUnlocked: false, progress: 0, category: ACHIEVEMENT_CATEGORY.EDGE_CREATOR },

  // ALGORITHM RUNS //
  // PROGRESSION for algorithm run (all algorithms at least once)
  { id: ACHIEVEMENT_ID.ALGOHOLIC, name: 'Algoholic 📊', description: "You've got the bug! Ran all algorithms at least once. Now for the hard part: remembering them all.", criteria: { ranAlgorithms: { DFS: false, BFS: false, Dijkstra: false, Kruskal: false, Prim: false, AllPaths: false, Eades: false } }, isUnlocked: false , category: ACHIEVEMENT_CATEGORY.ALGORITHM_RUN},

  // Algorithm Combinations
  { id: ACHIEVEMENT_ID.THE_TRAVERSER, name: 'Pathfinder Duo 🤝', description: "You've proven your versatility! Ran both BFS and DFS to explore the graph. No stone unturned!", criteria: { ranAlgorithms: { BFS: false, DFS: false } }, isUnlocked: false, category: ACHIEVEMENT_CATEGORY.ALGORITHM_COMBO },
  { id: ACHIEVEMENT_ID.SHORTEST_ROMANTIC, name: 'Love at First Path 💘', description: "Who needs a map? You ran Dijkstra from a node labeled \"me\" to a node labeled \"you\" for the ultimate shortest path!", criteria: {}, isUnlocked: false, category: ACHIEVEMENT_CATEGORY.ALGORITHM_COMBO },
  ...
  // DELETION MASTERY //
  { id: ACHIEVEMENT_ID.SHIFT_STRIKER, name: 'Demolitionist Dexterity 💥', description: "With a shift and a click, you've precise-demolished 10 nodes! Watch out, graph, they're coming for you!", criteria: { target: 10 }, isUnlocked: false, progress: 0, category: ACHIEVEMENT_CATEGORY.DELETION },
  { id: ACHIEVEMENT_ID.EDGE_ASSASSIN, name: 'Cutting Edge Master 🗡️', description: "A true blade runner! You've expertly sliced 25 edges from existence. No loose ends!", criteria: { target: 25 }, isUnlocked: false, progress: 0, category: ACHIEVEMENT_CATEGORY.DELETION },
...
export const ACHIEVEMENT_CATEGORY_INFO: { [key in ACHIEVEMENT_CATEGORY]: CategoryInfo } = {
  ...
  [ACHIEVEMENT_CATEGORY.DELETION]: {
    name: 'Demolition Expert',
    description: 'The precise and effective removal of graph elements. Less is more, sometimes.'
  },
